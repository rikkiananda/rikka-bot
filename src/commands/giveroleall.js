...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('giveroleall')
    .setDescription('Give a specific role to all eligible members in the server'),
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const roleId = '1443735439231160424';
      ...
      await interaction.editReply({ content: `Role has been given to ${addedCount} members.` });
    } catch (error) {
      console.error(error);
